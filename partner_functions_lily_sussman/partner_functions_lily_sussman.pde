//Inspiration for this project came from Andy Wharhol's pop art
...
void draw() {
  ...
  //Michaels Code (which I used to make a mohawk on my robot) - it came from:https://github.com/mjiHM26/Intro-cs/blob/main/functions_exercise/functions_exercise.pde
  push();
  translate(550, 470);
  scale(0.4);
  thing();
...
//Michaels Code - his variable he set up
void thing() {
  fill (#F23A3A);
  push();
  translate(-200, -350);
